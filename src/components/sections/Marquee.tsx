...
const Marquee = () => {
    return (
        ...
        <div className="overflow-hidden bg-[#12DD27] py-2 rotate-[1.3deg] h-[4rem] md:h-[5rem] z-10 w-full flex items-center translate-y-[.3rem]  md:translate-y-[1rem] lg:translate-y-[1rem] xl:translate-y-[1rem] 2xl:translate-y-[3rem]">
